          ...
          <div className="selectTerm">
            <FormControl sx={{ m: 1, maxWidth: 150, minWidth: 200 }}>
              ...
              >
                ...
                <MenuItem value={2}>OiTv Veterano 12/2022</MenuItem>
                <MenuItem value={3}>OiTv Veterano 10/2022</MenuItem>
      ...
      <>
        <ThemeProvider theme={theme}>
          <div className="input-group">
            ...
            <h4 id="title">Informe abaixo os dados seus resultados!</h4>
            <TextField
              size="small"
            ...
            <footer>
              <h4>
                {renda <= 0
                  ? "Sem RV este mês"
                  : `Renda Variável: R$ ${renda.toFixed(2)}`}
              </h4>
            </footer>
          </div>
        </ThemeProvider>
